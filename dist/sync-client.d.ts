 ...
 */
export declare function validateProjectAccess(dashboardUrl: string, apiToken: string, projectId: string, vercelProtectionBypass?: string): Promise<void>;
/**
 ...
 */
export declare function fetchProjectConfig(dashboardUrl: string, apiToken: string, projectId: string, vercelProtectionBypass?: string): Promise<DashboardSyncConfig | null>;
/**
 * Get the last synced commit hash from the dashboard.
 * Returns null if no sync has been performed yet.
 */
export declare function getSyncMarker(dashboardUrl: string, apiToken: string, projectId: string, vercelProtectionBypass?: string): Promise<string | null>;
/**
 * Save the last synced commit hash to the dashboard.
 */
export declare function saveSyncMarker(dashboardUrl: string, apiToken: string, projectId: string, commitHash: string, vercelProtectionBypass?: string): Promise<void>;
export declare function syncToDashboard(dashboardUrl: string, apiToken: string, payload: {
    ...
    chunkIndex: number;
    isLastChunk: boolean;
}, vercelProtectionBypass?: string): Promise<{
    success: true;
    projectId: string;
    synced_at: string;
}>;
