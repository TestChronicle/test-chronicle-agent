 ...
 */
export function findDescribeBlocks(content: string, describePattern: RegExp): DescribeBlock[] {
 ...
 */
export function resolveParentDescribe(blocks: DescribeBlock[], index: number): string | undefined {
